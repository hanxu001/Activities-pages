...
$(function() {
    ...
    }, 2e3), $(".slide_list_box").css("height", 3.5 * $(".slide_show dd:first-child").height()), setInterval(function() {
...
var load = {
        ...
        resetFun: function() { $(".turntable_box .b").addClass("start"), $(".win_pop_box").hide() },
        rnd: function(t, e) {
...
//     $(".setUrlLink").attr("href", t), getIsRedirect ? location.href = t : $(".wrap").show()
